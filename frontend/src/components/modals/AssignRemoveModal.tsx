...
} from '../../services/artistService'; // Ensure correct paths for all service functions
import { getDoctorsNoDepartmentId, getDoctorsByDepartmentId } from '../../services/artworkService';
import { getNurseNoDepartmentId, getNurseByepartmentId } from '../../services/customerService';
import { getRoomNoDepartmentId, getRoomByDepartmentId } from '../../services/salesreportService';

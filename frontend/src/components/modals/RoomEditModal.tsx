...
import { DepartmentDto } from '../../types/artworkTypes'; // Import the department type
import { getDepartments } from '../../services/artistService'; // Import the getDepartments function
